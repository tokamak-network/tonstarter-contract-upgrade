...
// const LockTOS_BYTECODE = require("../../abis/LockTOS_BYTECODE.json");
const LockTOS_ABI =  require("../../abis/LockTOS.json");
const LockTOSProxy_ABI = require("../../abis/LockTOSProxy.json");

// const LockTOSProxy_ABI = require("../../abis/LockTOSProxy_ABI.json");
// const LockTOSProxy_BYTECODE = require("../../abis/LockTOSProxy_BYTECODE.json");
...
describe("Sale", () => {
    ...
    describe("#3. Initialize PublicSaleProxyFactroy and PublicSale", () => {
        ...
        it("#3-3. deploy LibPublicSale", async () => {
